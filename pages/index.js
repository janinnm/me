...
export default function Home(props) {
  return (
    <div class="bg-slate-900 min-h-fit min-w-fit">
      <Head>
        ...
        <section class="bg-slate-900 p-12">
          <nav class="py-10 mb-12 flex justify-between">
            ...
            <ul class="flex items-center">
              <Link href="/"><li class="text-white cursor-pointer text-1xl px-5"> Home </li></Link>
              <a href="#skills"><li class="text-white cursor-pointer text-1xl px-5"> Skills </li></a>
              <a href="#projects"><li class="text-white cursor-pointer text-1xl px-5"> Projects </li></a>
              <li><a class="bg-cyan-500 text-white px-4 py-2 rounded-md ml-8 flex" href="mailto:jvmanalili1@up.edu.ph"> Contact Me</a></li>
            </ul>
          </nav>  
          <div class="text-center p-10">
            <h2 class="text-5xl py-2 text-teal-600 font-medium">Janin Manalili</h2>
            <h3 class="text-2xl text-white py-2"> 안녕하세요. 저는 <span class="text-teal-500">자닌</span>이에요. 만나서 반가워요.</h3>
           ...
           My interests include  <span class="text-teal-500">Machine Learning, Data Science,</span> and <span class="text-teal-500">Computer Security. </span>  
            I have worked with different frameworks, but I would consider myself adept in languages such as  <span class="text-teal-500">Python, C,</span> and <span class="text-teal-500"> Javascript.</span>
            </p>
          </div>
          <div class="text-5xl flex justify-center gap-16 py-3 text-gray-400">
